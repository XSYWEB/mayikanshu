...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<!--表单开始-->
			<form class="form-horizontal" action="<%=basePath%>mayibackstage/user/doAddUser" method="post">
				<div class="form-group">
					<label class="col-sm-2 control-label">姓名</label>
					<div class="col-sm-3">
						<input name="u_name" type="text" class="form-control"  placeholder="name">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label">用户名</label>
					<div class="col-sm-3">
						<input name="u_user" type="text" class="form-control"  placeholder="12313213">
					</div>
				</div>
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">密码</label>
					<div class="col-sm-3">
						<input name="u_password" type="password" class="form-control" id="inputPassword3" placeholder="Password">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label">电话</label>
					<div class="col-sm-3">
						<input name="u_phone" type="text" class="form-control" placeholder="13594546545">
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label">年龄</label>
					<div class="col-sm-3">
						<input name="u_age" type="text" class="form-control" placeholder="20">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input  id="url1" name="u_images" type="text" class="dfinput" value="" readonly="readonly">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<label>
      				<input type="radio" name="u_sex"   id="optionsRadios1" value="0" checked> 男
      				<input type="radio" name="u_sex" id="optionsRadios2"  value="1">女
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<textarea name="u_introduce" cols="" rows="" class="form-control" id="description"></textarea><i id="description_message"></i>
					</div>
				</div>
