...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<!--表单开始-->
			<form action="<%=basePath%>mayibackstage/user/doUpdate" class="form-horizontal" method="post">
				<input name="id" type="hidden" class="dfinput" value="${requestScope.user.id}" />
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">昵称</label>
					<div class="col-sm-3">
						<input name="u_name" type="text" class="form-control" id="" value="${requestScope.user.u_name}">
					</div>
				</div>
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">密码</label>
					<div class="col-sm-3">
						<input name="u_password" type="password" class="form-control" id="inputPassword3" value="${requestScope.user.u_password}">
					</div>
				</div>
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">电话</label>
					<div class="col-sm-3">
						<input name="u_phone" type="text" class="form-control" id="inputPassword3" value="${requestScope.user.u_phone}">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-3">
						<label>
							<c:choose>
								<c:when  test="${requestScope.user.u_sex==1}">
									<input name="u_sex" type="radio" name="optionsRadios"   id="optionsRadios1" value="0" > 男
									<input name="u_sex" type="radio" name="optionsRadios" id="optionsRadios2"  value="1" checked>女
								</c:when>
								<c:otherwise>
									<input name="u_sex" type="radio" name="optionsRadios"   id="optionsRadios1" value="0" checked> 男
									<input name="u_sex" type="radio" name="optionsRadios" id="optionsRadios2"  value="1" >女
								</c:otherwise>
							</c:choose>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input  id="url1" name="u_images" type="text" class="dfinput" value="${requestScope.user.u_images}" readonly="readonly">
