...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<!--表单开始-->
			<form class="form-horizontal" action="<%=basePath%>mayibackstage/admin/addAdmin" method="post">
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">姓名</label>
					<div class="col-sm-3">
						<input name="a_name" type="text" class="form-control" id="fname" placeholder="name"><span id='DivFname'></span>
					</div>
				</div>
				<div class="form-group">
